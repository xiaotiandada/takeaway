<template>
  ...
  <div class="userContainer">
    ...
    <div class="usermenu">
      <i-cell-group>
        <i-cell title="历史订单" is-link>
            <i-icon slot="icon" type="document_fill" color="#0097ff" size="18" />
        </i-cell>
        <i-cell title="收货地址" is-link url="/pages/index/main">
        ...
        <i-cell title="联系商家" is-link url="/pages/index/main">
          <i-icon slot="icon" type="homepage_fill" color="#0097ff" size="18" />
        </i-cell>
        <i-cell title="意见反馈" is-link url="/pages/index/main">
